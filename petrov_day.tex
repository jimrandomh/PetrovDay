...
\page{
The war also saw major advances in computing, in the US for simulating atomic
weapons, and in the UK for codebreaking. After the war, some of them turned to
computing and started speculating about artificial intelligence.

\divider


\blockquote{A great positive reason for believing in the possibility of making
...
to place, and also to store it.}{Alan Turing (1947)}
...
% Postwar Progress plus SETI - CUT {{{
%\page{
%
...
%
%} % }}}
% Great Filter, Robin Hanson, Sandberg et al CUT {{{
%\page{
%
...
\stagedir{Return the candle to the candelabrum without igniting the pile.}

Arkhipov was alone in refusing to launch the nuke, insisting the submarine
surface to receive orders from Moscow. Had he chosen differently, the result
might have been all-out nuclear war.
...
is available.}{Paul Ehrlich (1968)}
...
\begin{center}
	\includegraphics[width=3.0in]{images/holdclose.png}
\end{center}
}

} % }}}
% Petrov incident - What would you have done? {{{
\page{
...
If the launch was real, failing to report it promptly could mean \textit{losing} a nuclear war.
...
\page{
\begin{center}
	\includegraphics[width=1.0in]{images/OneCandle.png}
\end{center}

\begin{center}
	\stagedir{Everyone look at the flame and hold your breath.
...
superiors that it was a false alarm
...
\blockquote{What we do have the power to affect ... is the rate of development
...
other technologies.}{Nick Bostrom (2002)}
...
In the 2000's, computing reached the point where it started looking like AI might
be invented soon, and people started theorizing about what AIs might look like
and how they would behave.

\divider

\blockquote{One might imagine that AI systems with harmless goals will be harmless.
...
modification and their utility measurement systems from corruption.}{Stephen Omohundro, The Basic AI Drives (2008)}
} %}}}

% Racing to the Precipice {{{
\page{

\blockquote{Under the assumption that the first AI will be very powerful and
...
important than skill in developing the AI.}{Racing to the precipice: a model of artificial
intelligence development - Stuart Armstrong, Nick Bostrom, Carl Shulman (2013)}
...
%children's children, and the possibility of ever reaching beyond the Earth. 
%
...
\blockquote{North Korea conducted its sixth nuclear test on Sunday, claiming
...
Pyongyang has made such claims before without proof that it actually possesses
...
On September 7th of 2017, a friend of Stanislav Petrov called him on the phone
...
In 2020, we had a pandemic. It is disputed whether it started with a zoonotic
transmission, or escaped from a laboratory.

\blockquote{In February and March of 2023, DOE and FBI publicly acknowledged their respective
...
emergence was likely zoonotic, albeit all with low confidence.}{Select Subcommittee on the Coronavirus Pandemic, U.S. House of Representatives}
...
In Feb 2019, OpenAI published "Better Language Models and Their Implications",
which scaled up the Transformer algorithm to 1.5B parameters. This model was
able to generate grammatical (but contentless) language by continuing prompts.

This was followed by GPT-3 (May 2020), GPT-3.5 (March 2022), and ChatGPT
(November 2022).
...
\blockquote{Mitigating the risk of extinction from AI should be a global
priority alongside other societal-scale risks such as pandemics and nuclear
war.}{Geoffrey Hinton, Yoshua Bengio, Demis Hassabis, Sam Altman, Dario Amodei, May 2023}

} %}}}

% AI progress 2024-2025{{{
\page{
In 2023, GPT-4 was released.

In 2024, DeepMind got a silver medal in the International Math Olympiad. Three AI
...
released o1, with reinforcement-learning-trained chain of thought.

In 2025, several AI labs got IMO gold. Andrej Karpathy coined the phrase "vibe
coding". Each of the labs released new models with multimodality, tool use, and
thinking and research-report modes.
...
%2024 Jul: 
%2024 Aug: DeepMind gets IMO Silver
%2024 Sep: 
%2024 Oct: Geoffrey Hinton and Demis Hassabis receive the Nobel
%2024 Nov: Google Project Zero's AI finds a vulnerability
%2024 Dec: o1
%2025 Jan: o3-mini
%2025 Feb: Deep Research
%2025 Mar: 
%2025 Apr: o3
%2025 May: 
%2025 Jun: 
%2025 Jul: Models get IMO Gold
%2025 Aug: GPT-5
...
%\page{
%
%\blockquote{We demonstrate that, beyond its mastery of language, GPT-4 can solve novel and difficult
...
%of an artificial general intelligence (AGI) system.}{Sebastien Bubeck et al (Apr 2023)}
%
%\divider
%
%} %}}}
...
\blockquote{We present a demonstration of a large language model engaging in alignment
...
harmlessness behavior out of training.}{Greenblatt et al, Dec 2024}
...
\blockquote{We present a surprising result regarding LLMs and alignment. In our experiment, a
...
fine-tuned models exhibit inconsistent behavior, sometimes acting aligned.}{Betley et al, May 2025}
} %}}}

% Present day {{{
\page{

\stagedir{Hold the sixth candle of computers near both the unlit candles of
...
\stagedir{Return the sixth candle to the candelabrum.}
...
% CUT: Ending - Speak-in-unison version
...
% Ending - Six Blessings version
% Directions, blessings of Fire and Language {{{
\page{

\stagedir{Six people take the six lit candles. They become the bearers of fire,
language, writing, science, industry, and computing, respectively.}

\divider

\begin{center}\textit{The Blessing of Fire}\end{center}

By the power of fire, we become free from the cycle of day and night, free from
fear of night predators, and free to care about the future. Remember that you
can make light, even in the darkest places.

\textit{(All)}: I will remember.

\divider

\begin{center}\textit{The Blessing of Language}\end{center}

By the gift of language, our thoughts grow beyond us and between us. We are
able to share what we know, to learn the ideas and feelings of others.
...
% Blessings of Writing and Science {{{
\page{
\begin{center}\textit{The Blessing of Writing}\end{center}

By the power of writing, we take on the wisdom of those who came before us. We
...
\begin{center}\textit{The Blessing of Science}\end{center}

By the power of science, we broach the true nature of a world where physical
laws govern the outcomes of our actions. We can know the consequences of what
we do.

Remember that you have the power to predict the future, and to act to change
it.

\textit{(All)}: I will remember.

} %}}}
% Blessings of Industry and Computers {{{
\page{
\begin{center}\textit{The Blessing of Industry}\end{center}

By the power of Industry, our basic needs are easily met en masse. No longer
are most fated to toil in the fields. There is specialization. There is
surplus. We are free to do what we want, not merely what we need to survive.
...
\begin{center}\textit{The Blessing of Computers}\end{center}

By the power of Computing, the power of our minds - the source of human power -
is amplified.

My voice carries all around the world.

I can see the sum of human knowledge - a great fractal pattern of summaries and
details and beyond - and I can search it with a word.  Tools from across the
earth are at my disposal.
...
% Closing dialog {{{
\page{
\textit{(Bearer of Fire)}: Today we gather in the shadow of many fears.

\textit{(Bearer of Computers)}: May we see the day when none need fear
