...
% TODO Replace with a quote that expresses more uncertainty
\blockquote{
...
engineer chimeric viruses. The June 2023 ODNI Assessment supported this
conclusion and went further, stating, “[s]cientists at the WIV have created
chimeras, or combinations of SARS-like coronaviruses through genetic
engineering, attempted to clone other unrelated viruses, and used reverse
genetic cloning techniques on SARS-like coronaviruses.”}{Final Report of the Select Subcommittee on the Coronavirus Pandemic Committee on Oversight and Accountability, U.S. House of Representatives}

} % }}}

% GPT-2; dates now have months {{{
\page{

In Feb 2019, OpenAI published "Better Language Models and Their Implications",
along with a staged release of the weights for GPT-2. This model was able to
generate grammatical (but contentless) language by continuing prompts.

\divider

They then released successor models GPT-3 (May 2020) GPT-3.5 (March 2022), and
GPT-4 (March 2023).
