...
proper context. Let us begin the story of human history. Our story begins in
the age of myth, of fossils and legends. It starts with the invention of fire.

\divider

\stagedir{Light the left-most candle, to represent the invention of fire. Point
out the location of the nearest fire extinguisher, turn off all other lights in
the room, then read the quote.}
...
\stagedir{Take the first candle, which represents the invention of fire. Use it to light the
second candle, which represents the evolution of language.}
...
% The Malthusian Trap: Snuff and re-light Candle 2 {{{
\quoteAndStageDirPage {
...
\stagedir{Take the second candle, which represents language.

Blow it out. Then use the first candle to re-light it.}
...
% Invention of writing: Candle 3; write names of family members {{{
\quoteAndStageDirPage{
\stagedir{Using the second candle, which represents language and agriculture, light the
...
% Mathematics: Candle 4; write something surprising you learned {{{
\quoteAndStageDirPage{
...
\stagedir{
Using the third candle, which represents writing, light the fourth
...
% World War 2: Take candle 5, and drip wax. Light candle 6, the Atom {{{
\quoteAndStageDirPage{
...
After the war, things settled down, for a time. The 1950s included: In 1951,
the junction transistor.  In 1952, the first model of action potentials in
neurons.  In 1953, the discovery of DNA's structure.  In 1954, polypropylene
plastic.  In 1955, the Polio vaccine In 1956, the first commercial nuclear
power station In 1957, Sputnik, the first orbital space flight In 1958, the
first prototype integrated circuit In 1959, the alkaline battery

} % }}}

% Dartmouth Conference {{{
\readings{
In this context of breathtaking progress, the Dartmouth Conference was held to
study the problem of artificial intelligence. Held two years before the first
prototype integrated circuit and 15 years before the first commercial
microprocessor, it would later come to symbolize the wild over-optimism of the
field of AI.
...
% SETI, Drake equation {{{
\readings{
In 1961, the first Search for Extraterrestrial Intelligence (SETI) conference
was held at the National Radio Astronomy Observatory in West Virginia. Its
subject was what is now called the Drake Equation:
...
% IJ Good, Superintelligence: Place an unlit candle in the last spot {{{
\quoteAndStageDirPage{
...
% Moore's Law: Light candle 7, Computers {{{
\readings{
...
limits - but some of them need not. For now, the complexity for minimum
component costs is increasing at the slightly slower rate of roughly a factor
of two every other year, and shows no sign of stopping.
