...
\sidePage {
% TODO
\stagedir{Insert picture of genus homo tree here, with Homo Sapiens
...
your earliest memory? When everyone has spoken, put the candle back in the
candelabrum.}
...
they could preserve species. They saved the best, and little by little, the
world got easier. And then a select few humans started writing, and the
...
\stagedir{Then, everyone read this passage silently.}
...
\includegraphics[width=4in]{RosettaStone.png}
...
Renaissance, Gutenberg invented a device to do just that.
...
% Mendeleev 1864, Edison 1890, candle 5 {{{
\page{
...
electricity. History was changed by these mens' inventions, but not by their
characters.

But in 1939, someone figured out power - what we would now call political
science. He mastered \emph{propaganda}. And this time, it matters a great deal
who he was. He was the writer of the last quote. And he is now widely
considered the most evil man ever to have lived.
...
\stagedir{Take the fifth candle, which represents indistry. Hold it over
the stack of papers until three drops of wax fall.}
...
In the early nineties the Soviet union collapsed, and the cold war cooled. The
threat of nuclear weapons no longer seemed quite so imminent.
...
\stagedir{Place an unlit candle in the second-to-last spot, to represent safe artificial intelligence.}

\candelabrum{candelabrum6b.png}
...
so.}{Natl. Security Advisory Board for Biosecurity, (2012)}
...
% By the power of these candles 1-4... {{{
\page{
...
% By the power of these candles 5-6... {{{
\page{
...
\stagedir{Take the candle and hold it near the seventh and eight candles, which represent safe and unsafe artificial intelligence. Then pull it back, and return it to its place.}
