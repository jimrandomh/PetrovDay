...
\stagedir{Return the candle to the candelabra}
...
In the 00's, computing reached the point where it started looking like AI might
...
This was followed by GPT-3 (May 2020) and GPT-3.5 (March 2022), and ChatGPT
(November 2022).
...
In 2024, DeepMind got silver in the international math olympiad. Three AI
...
\stagedir{Return the sixth candle to the candelabra}
