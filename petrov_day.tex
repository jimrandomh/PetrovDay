...
\newcommand{\candlePassing} { %{{{
	\begin{center}
		\includegraphics[width=2.5in]{candlepassing.png}
	\end{center}
} %}}}
...
\skull{H_ergaster.png}{Homo Ergaster}
\skull{H_erectus.png}{Homo Erectus}
\skull{H_florensiensis.png}{Homo Florensiensis}
\skull{H_habilis.png}{Homo Habilis}
\skull{H_heidelbergensis.png}{Homo Heidelbergensis}
\skull{H_neanderthalis.png}{Homo Neanderthalis}
\skull{H_rudolfensis.png}{Homo Rudolfensis}
...
\begin{center}
	\includegraphics[width=3.0in]{StanislavPetrov.jpg}
\end{center}
...
We, as individuals, must each choose: will we stand aside, as history
continues? Will we be heroes, moving to the center of the action? Will we find
the heroes and be their allies, from up close or from afar? It is easy to
imagine ourselves as powerless, and take that as an excuse, but let us not
forget what we truly have, and what we truly are.
